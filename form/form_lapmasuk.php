...
if($_SERVER['REQUEST_METHOD']=='POST'){
    $submit = $lap->lapBarangMasuk($_POST);   //menggunakan method tambahSupplier()
}
?>
                ...
                <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <h2 class="text-left">LAPORAN BARANG MASUK</h2>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="../view/view_lapmasuk.php" method="post">
                                <div class="mb-3">
